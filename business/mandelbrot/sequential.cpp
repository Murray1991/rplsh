...
int main(int argc, char *argv[]) {
    ...
    std::cout << "total mandel: " << tot32a << ", per task: " << (tot32a/streamsize) << ", per subtask: " << (tot32b/streamsize) << std::endl;
    std::cout << "total drain: " << tot43 << ", per task: " << (tot43/streamsize) << std::endl;
